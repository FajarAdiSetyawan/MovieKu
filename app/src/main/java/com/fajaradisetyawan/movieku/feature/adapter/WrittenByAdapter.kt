/*
 * Created by Fajar Adi Setyawan on 16/12/2022 - 12:21:34
...
class WrittenByAdapter: RecyclerView.Adapter<WrittenByAdapter.ViewHolder>() {
    private var crew: List<Crew>? = null

    fun setWriter(crewList: List<Crew>?) {
        this.crew = crewList
    }
