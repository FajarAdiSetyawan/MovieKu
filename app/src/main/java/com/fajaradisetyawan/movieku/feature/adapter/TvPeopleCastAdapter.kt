...
class TvPeopleCastAdapter: RecyclerView.Adapter<TvPeopleCastAdapter.ViewHolder>() {
    private var tvShow: List<TvShowCastPeople>? = null

    private var onItemClickListener: ((TvShowCastPeople) -> Unit)? = null

    fun setOnItemClickListener(listener: (TvShowCastPeople) -> Unit) {
        onItemClickListener = listener
    }

    fun setTvShowPeopleCast(tvShowList: List<TvShowCastPeople>?) {
    ...
    inner class ViewHolder(private val binding: ItemListBinding) :
        ...
        fun bind(tvShow: TvShowCastPeople) {
            with(binding) {
                ...
                tvReleaseDate.text = tvShow.character
