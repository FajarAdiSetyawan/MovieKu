...
import com.fajaradisetyawan.movieku.feature.adapter.SeasonListPagingAdapter
...
import com.fajaradisetyawan.movieku.feature.ui.detail.tvshow.season.viewmodel.AllSeasonViewModel
...
class AllSeasonFragment : Fragment() {
    ...
    private fun allSeason(detail: TvShowDetail){
