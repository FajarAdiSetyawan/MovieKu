...
import com.fajaradisetyawan.movieku.adapter.MovieListBigAdapter
...
import com.fajaradisetyawan.movieku.ui.detail.movie.viewmodel.CollectionViewModel
...
class CollectionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        getAllMovie(collection.id)
        getImageCollection(collection)
    }

    @SuppressLint("NotifyDataSetChanged")
    private fun getAllMovie(id: Int){
        binding.layoutContent.apply {
            ...
            shimmerCollectionMovie.visibility = View.VISIBLE
            shimmerCollectionMovie.startShimmer()
    ...
    private fun getImageCollection(collection: Collection){
